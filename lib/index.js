...
`code="{codeFromUrl}"` and resume the script. \n\n\n';
    ...
    const path = require('path'),
        ...
        scopes = ['https://www.googleapis.com/auth/drive'], { google } = require('googleapis');

        console.log( 'Trying with keyfile: ', keyfile );
        ...
        return new Promise((resolve, reject) => {
            ...
            if (fs.existsSync(tokenfile)) {
                ...
                if (token.refresh_token && token.access_token) {
                    ...
                    console.log('Loaded existing tokenfile: ' + tokenfile);
                }
            }
                    ...
                    .then(res => {
                        if (res.tokens) {
                            ...
                            fs.writeFile(tokenfile, JSON.stringify(tokens), err => {
                                ...
                                console.log("Token file written to:" + tokenfile);
